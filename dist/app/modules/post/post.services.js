...
const createPost = (file, data, id) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllPost = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const post of posts) {
        ...
        const userAlreadyReacted = reactions.some(reaction => (reaction === null || reaction === void 0 ? void 0 : reaction.userId.toString()) === id);
        const postWithReactions = Object.assign(Object.assign({}, post.toObject()), { reactions,
            userAlreadyReacted });
        postsWithReactions.push(postWithReactions);
    }
    return postsWithReactions;
});
const getMyPost = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const post of sharedPosts) {
        ...
        const reactions = yield loveReact_model_1.LoveReact.find({ postId: sharedPost._id });
        const userAlreadyReacted = reactions.some(reaction => (reaction === null || reaction === void 0 ? void 0 : reaction.userId.toString()) === id);
        const postWithReactions = Object.assign(Object.assign({}, post.toObject()), { reactions,
            userAlreadyReacted });
        postsWithReactions.push(postWithReactions);
    }
    postsWithReactions.sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());
    return postsWithReactions;
});
