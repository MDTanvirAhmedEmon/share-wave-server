...
const signUpUser = data =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = (0, jwtHelper_1.createAccessToken)(
      tokenData,
    ...
    const refreshToken = (0, jwtHelper_1.createAccessToken)(
      tokenData,
      config_1.default === null || config_1.default === void 0
        ? void 0
...
const signInUser = data =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      (isExist === null || isExist === void 0 ? void 0 : isExist.password) !==
      data.password
    ) {
...
const updateProfilePicture = (file, id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const data = {}
    const postData = {}
...
const updateCoverPhoto = (file, id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const data = {}
    const postData = {}
    const uploadedImage = yield (0, fileUploader_1.uploadToCloudinary)(file)
...
const getAllUser = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield users_model_1.User.find({ _id: { $ne: id } }).select(
...
const getSingleUser = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield users_model_1.User.findById({ _id: id }).select(
