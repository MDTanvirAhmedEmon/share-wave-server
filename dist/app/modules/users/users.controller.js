...
const signUpUser = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const _a = yield users_services_1.userServices.signUpUser(userData),
        { refreshToken } = _a,
        others = __rest(_a, ['refreshToken'])
      const cookieOptions = {
...
const signInUser = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const userData = req.body
      const _b = yield users_services_1.userServices.signInUser(userData),
        { refreshToken } = _b,
        others = __rest(_b, ['refreshToken'])
      const cookieOptions = {
        secure: config_1.default.env === 'production',
        httpOnly: true,
      }
    ...
    try {
      ...
      const id =
        ...
        _d === void 0
          ? void 0
          : _d.id
      const result = yield users_services_1.userServices.updateProfilePicture(
        file,
        id,
      )
      res.status(200).json({
...
const updateCoverPhoto = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _e
    try {
      const file = req.file
      const id =
        ...
        _e === void 0
          ? void 0
          : _e.id
      const result = yield users_services_1.userServices.updateCoverPhoto(
        file,
        id,
      )
      res.status(200).json({
